...
class TestApp:
    def __init__(self, root):
        ...
        self.save_path_label = tk.Label(root, text=str("/home/admin/capstonelab/tests/"), fg="blue")
    ...
    def start_tests(self):
        ...
        self.save_path_label = tk.Label(root, text=str(directory_name), fg="blue")
        for i in range(4):
            ...
            image_path = os.path.join(directory_name, f"Test_Result_{i+1}.png")    
            #image_path = self.test_results_dir / f"Test_Result_{i+1}.png"

            # Run the IV sweep test
            SCPIVS.perform_iv_sweep(directory_name, i+1)
